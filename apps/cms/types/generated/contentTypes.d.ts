...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course category (e.g. Quran, Hadith, Fiqh, Arabic)';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course offered on the academy';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course instructor profile';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Lesson inside a module';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['video', 'reading', 'quiz']> &
      Schema.Attribute.Required &
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course module \u2014 groups lessons';
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student review for a course';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
